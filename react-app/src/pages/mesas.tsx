      ...
      <div className="mesas-container">
        ...
        <div className="mesas-grid">
          {tables.map((table) => (
            <div
              key={table.table_id}
              className={`mesa-card ${table.status ? "occupied" : "available"}`}
              onClick={() => toggleTableStatus(table)}
              style={{ cursor: "pointer" }}
            >
              <h3>Mesa #{table.table_id}</h3>

              <div className="mesa-view">
              ...
              <p>
                ...
                <span className="capacity-number">{table.number_guests} personas</span>
              </p>
              ...
              <p>
                ...
                {table.status ? (
                  ...
                  <span className="status-available">Libre</span>
                )}
              </p>
            </div>
          ))}
